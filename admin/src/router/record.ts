...
export const routeRecordRaw: MenuMixedOptions[] = [
  ...
  {
    path: 'media-records',
    name: 'mediaRecordManagement',
    icon: 'iconify ph--film-strip',
    label: '影视记录',
    redirect: 'media-records/list',
    children: [
      {
        path: 'list',
        ...
        label: '记录列表',
        icon: 'iconify ph--list-bullets',
        meta: { componentName: 'MediaRecordList', showTab: true },
        component: 'media-records/index',
      },
      {
        path: 'edit/new',
        name: 'mediaRecordCreate',
        label: '新增记录',
        icon: 'iconify ph--pencil-simple-line',
        meta: { componentName: 'MediaRecordEdit', showTab: true, enableMultiTab: true, renderTabTitle: () => '新增影视记录' },
        component: 'media-records/edit',
      },
      {
        path: 'edit/:id',
        name: 'mediaRecordEdit',
        label: '编辑记录',
        show: false,
        meta: { componentName: 'MediaRecordEdit', showTab: true, enableMultiTab: true, renderTabTitle: ({ id }) => `编辑影视记录${id ? `-${id}` : ''}` },
        component: 'media-records/edit',
      },
    ],
  },
  {
    ...
    label: '足迹管理',
    redirect: 'footprints/list',
    children: [
      {
        path: 'list',
        name: 'footprintList',
        label: '行程列表',
        icon: 'iconify ph--path',
        meta: { componentName: 'FootprintList', showTab: true },
      ...
      },
      {
        ...
        label: '新增行程',
        icon: 'iconify ph--plus',
        meta: {
          componentName: 'FootprintEdit',
          showTab: true,
          enableMultiTab: true,
          renderTabTitle: () => '新增足迹',
        },
        component: 'footprints/edit',
      },
      {
        path: 'edit/:id',
        name: 'footprintEdit',
